...
<form method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="meter" placeholder="No Meter">
  </div>
  ...
  <div class="form-group">
    ...
    <input class="form-control" name="kode" placeholder="Kodetarif" type="text">
  </div>
  	<!--<div class="form-group">
...
-->
  ...
  <a class="btn btn-danger" href="?menu=data_distributor">Kembali</a>
