...
<form>
  ...
  <div class="form-group">
    ...
    <input type="text" name="" class="form-control" name="alamat"placeholder="Alamat Pegawai (kasir)"> 
  </div>

  <div class="form-group">
    <label>Telepon</label>
    <input class="form-control" name="telpon" placeholder="Nomer Telpon" type="number">
  </div>
